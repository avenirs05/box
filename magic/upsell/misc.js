function email_focus() {
	if ($(this).val() == '../../../pantra.ru/upsell/timer/js/your_40email.com') {
		$(this).val('')
...
function email_blur() {
	if ($(this).val() == '') {
		$(this).val('../../../pantra.ru/upsell/timer/js/your_40email.com')
		$(this).addClass('faded');
	}	
}
...
function subscribe_submit() {
	...
	$.post('../../../pantra.ru/upsell/timer/js/subscribe.php@json=1', $('#subscribe_form').serialize(), subscribe_result, 'json');
