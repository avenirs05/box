...
<script>
  ...
  fbq('init', '1989949011270501');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=1989949011270501&ev=PageView&noscript=1"
/></noscript>
...
<div class="tov-info"><h3>Детская гоночная трасса Magic Track</h3><div class="tov-info-rate"></div>
<div class="tov-info-cost"><span class="old-cost">1990<small> р</small></span>
<span class="new-cost">990<small> р</small></span></div><p class="tov-info-text"><blockquote>
...
<form action="form3.php" method="post">
  ...
  <input name="name777" type="hidden" value="Набор Magic Track за 990 руб.">
...
<div class="tov-item tov-rate-1 clearfix"><span class="tov-item-sale">-40%</span>
...
<div class="tov-info"><h3>Спиннер, светящийся в темноте</h3><div class="tov-info-rate"></div>
<div class="tov-info-cost"><span class="old-cost">590<small> р</small></span>
<span class="new-cost">390<small> р</small></span></div><p class="tov-info-text"><blockquote>
<ul>Самая популярная игрушка-антистресс среди детей!<br>
- В каждой лопасти Спиннера по 3 диода разных цветов (синий, зеленый, красный)<br>
- 1 нажатие -  активируется режим быстрого мерцания<br>
- 2 нажатия - режим поочередного мерцания<br>
- 3 нажатия - режим медленного поочередного мерцания с переходом в быстрое поочередное мерцание<br>
- 4 нажатия - выключение диодов.<br>
</ul></blockquote></p>
<form action="form3.php" method="post">
  <input name="name" type="hidden" value="<?=$name?>">
  <input name="phone" type="hidden" value="<?=$phone?>">
  <input name="name777" type="hidden" value="Спиннер светящийся за 390 руб.">
